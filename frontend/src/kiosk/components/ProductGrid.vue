...
.photo img {
  ...
  /* Масштаб задаёт оператор: снимки из товароучёта сняты по-разному, и один
     ...
     границами карточки; уменьшение показывает снимок целиком — для этого вместе
     с масштабом меняется и способ вписывания (`contain` ниже 100 %), иначе
     фотография так и осталась бы обрезанной, только меньше. */
  object-fit: var(--ui-photo-fit, cover);
