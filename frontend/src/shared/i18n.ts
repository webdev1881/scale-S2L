  ...
  uk: {
    ...
    admin: {
      ...
      settings: {
        ...
        clearHold: 'Порожня платформа, с',
        clearHoldHint:
          'Скільки секунд платформа має простояти вільною після друку, щоб кіоск вважав покупку завершеною.',
  ...
  ru: {
    ...
    admin: {
      ...
      settings: {
        ...
        clearHold: 'Пустая платформа, с',
        clearHoldHint:
          'Сколько секунд платформа должна простоять свободной после печати, чтобы киоск счёл покупку законченной.',
