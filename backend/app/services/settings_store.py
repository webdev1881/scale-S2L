...
class DeviceSettings(BaseModel):
    ...
    # Кнопки нижней панели во всю ширину экрана, а плитка выбранного товара — над
    # ними отдельной строкой. Так «Усі товари» и «ПОШУК товару» делят ровно
    # половину экрана каждая, а не половину остатка после плитки: до кнопки тянутся
    # стоя, и чем она шире, тем меньше промахов.
